...
| 第2讲  | PyCharm的下载、安装和卸载，磨刀不误砍柴工                                                 | 待整理                                                            |
| 第3讲  | 不要重复造轮子原来是这个意思！pip的下载、安装和使用，编程准备工作最后一站                 | 待整理                                                            |
| 第4讲  | Word文件转PDF文件，用Python怎么做？如果是1000个文件呢？                                   | 待整理                                                            |
| 第5讲  |                                                                                           | 待整理                                                            |
| 第6讲  |                                                                                           | 待整理                                                            |
| 第7讲  |                                                                                           | 待整理                                                            |
| 第8讲  |                                                                                           | 待整理                                                            |
...
- 本套课程的70多个功能，全部来自开源项目：``python-office``，相关视频：[官网发布：python-office库 | 专为Python自动化办公而生，一行代码提高办公效率 | 哪里不会点哪里，再也不用学习Python编程](https://www.bilibili.com/video/BV1pT4y1k7FH)

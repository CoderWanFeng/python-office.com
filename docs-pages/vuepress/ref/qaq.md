...
另外说明一下，视频教程配套的：**软件、代码、文档、答疑群**，是收费的，78元钱（780微信豆）👉[点我获取资料](https://mp.weixin.qq.com/s/VH93du82QMuPz_1V3c5a6w)
...
### 第4讲中，PDF转Word，结果还是不能编辑？

在PDF文件是扫描件的情况下，转换代码能运行成功，但是不能编辑。

...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(_attrs)}><h1 id="pdf" tabindex="-1"><a class="header-anchor" href="#pdf" aria-hidden="true">#</a> PDF</h1><h2 id="_1、加密、解密" tabindex="-1"><a class="header-anchor" href="#_1、加密、解密" aria-hidden="true">#</a> 1、加密、解密</h2><p>文字说明：<a href="https://mp.weixin.qq.com/s/YOxBzYPMqfl5gCAWtnVXKA" target="_blank" rel="noopener noreferrer">传送门`);
  _push(ssrRenderComponent(_component_ExternalLinkIcon, null, null, _parent));
  _push(`</a></p><p><strong>加密</strong></p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token comment"># 导入这个库</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_2、加水印" tabindex="-1"><a class="header-anchor" href="#_2、加水印" aria-hidden="true">#</a> 2、加水印</h2><p>文字说明：<a href="https://mp.weixin.qq.com/s/yJDs5RoytRL5hl-ybXkZOA" target="_blank" rel="noopener noreferrer">传送门`);
  _push(ssrRenderComponent(_component_ExternalLinkIcon, null, null, _parent));
  _push(`</a></p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token keyword">import</span> office  <span class="token comment"># 导入python-office</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_3、-合并2个pdf" tabindex="-1"><a class="header-anchor" href="#_3、-合并2个pdf" aria-hidden="true">#</a> 3、 合并2个PDF</h2><p>文字说明：<a href="https://mp.weixin.qq.com/s/9erh3W3WCD36Axj70pRvog" target="_blank" rel="noopener noreferrer">传送门`);
  _push(ssrRenderComponent(_component_ExternalLinkIcon, null, null, _parent));
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_4、转-word" tabindex="-1"><a class="header-anchor" href="#_4、转-word" aria-hidden="true">#</a> 4、转 Word</h2><p>文字说明：<a href="https://mp.weixin.qq.com/s/O0pJOs9stD1prENP4N8QYg" target="_blank" rel="noopener noreferrer">传送门`);
  _push(ssrRenderComponent(_component_ExternalLinkIcon, null, null, _parent));
  _push(`</a></p><blockquote><p>请注意，使用这个功能，一定要把python-office，更新到最新版本！ 查看最新版本号：https://pypi.org/project/python-office/</p></blockquote><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>更新命令：pip install -i https://mirrors.aliyun.com/pypi/simple python-office -U
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_5、-txt-转成-pdf" tabindex="-1"><a class="header-anchor" href="#_5、-txt-转成-pdf" aria-hidden="true">#</a> 5、 TxT 转成 PDF</h2><p>文字说明：<a href="https://mp.weixin.qq.com/s/GiXYB_xZdlsYv5AIeIELkA" target="_blank" rel="noopener noreferrer">传送门`);
  _push(ssrRenderComponent(_component_ExternalLinkIcon, null, null, _parent));
  _push(`</a></p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token comment"># 导入这个库：python-office，简写为：office</span>
<span class="token keyword">import</span> office
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_6、转图片" tabindex="-1"><a class="header-anchor" href="#_6、转图片" aria-hidden="true">#</a> 6、转图片</h2><p>文字说明：<a href="https://mp.weixin.qq.com/s/tvHZIBGcrMBLTLB4u23Mow" target="_blank" rel="noopener noreferrer">传送门`);
  _push(ssrRenderComponent(_component_ExternalLinkIcon, null, null, _parent));
  _push(`</a></p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token comment"># 导入这个库：python-office，简写为office</span>
<span class="token keyword">import</span> office
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../pages/office/pdf.html.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const pdf_html = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__file", "pdf.html.vue"]]);
export {
  pdf_html as default
};

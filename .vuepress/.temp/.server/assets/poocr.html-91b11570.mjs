...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(_attrs)}><h1 id="文字识别" tabindex="-1"><a class="header-anchor" href="#文字识别" aria-hidden="true">#</a> 文字识别</h1><ul><li><p><a href="https://mp.weixin.qq.com/s/WxICBZZSgkm-OrvXB82hbg" target="_blank" rel="noopener noreferrer">全部100+功能的说明`);
  _push(ssrRenderComponent(_component_ExternalLinkIcon, null, null, _parent));
  _push(`</a></p></li><li><p>识别发票：<a href="https://www.bilibili.com/video/BV1Y3411R7q7/" target="_blank" rel="noopener noreferrer">视频`);
  _push(ssrRenderComponent(_component_ExternalLinkIcon, null, null, _parent));
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../pages/video/poocr.html.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const poocr_html = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__file", "poocr.html.vue"]]);
export {
  poocr_html as default
};
